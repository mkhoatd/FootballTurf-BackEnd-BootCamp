...
namespace WebApi.Persistence.Migrations
{
    ...
    [Migration("20211217093540_ReactionTableKey")]
    partial class ReactionTableKey
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.Reaction", b =>
                {
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.Reaction", b =>
                {
                    b.HasOne("WebApi.Domain.Entities.Answer", "Answer")
                        .WithMany("ReactedByPlayers")
                        .HasForeignKey("AnswerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApi.Domain.Entities.AppUser", "User")
                        .WithMany("ReactedQuestions")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
